...
describe('orchestration RPC methods', () => {
  ...
  it('registers all expected methods', () => {
    ...
    expect(registry.has('orchestration.consoleList')).toBe(true)
    expect(registry.has('orchestration.consoleSnapshot')).toBe(true)
    expect(registry.has('orchestration.consoleReply')).toBe(true)
    expect(registry.has('orchestration.consoleResolveGate')).toBe(true)
    expect(registry.has('orchestration.consoleSendFollowup')).toBe(true)
    expect(registry.has('orchestration.consoleStopWorker')).toBe(true)
    expect(registry.has('orchestration.consoleAbandonWorker')).toBe(true)
    expect(registry.has('orchestration.consoleReleaseWorker')).toBe(true)
    expect(registry.has('orchestration.consoleRetainWorker')).toBe(true)
