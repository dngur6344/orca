...
export type GlobalSettings = {
  ...
  /** Per-worktree shell history for workspace terminals; the global floating terminal stays on the
   *  shell's global history. Uses HISTFILE for bash/zsh and `fish_history` for fish. Defaults true. */
